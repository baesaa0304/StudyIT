...
document.addEventListener("DOMContentLoaded", function(){
    ...
    // addEventListene('eventName', eventListener);
    ...
    btn2.addEventListener('click', function () {
        // calss = "c1"인 요소들의 바탕색을 Lime으로 변경
    ...
    // CSS selector(선택자)문법을 argument 사용하는 메서드:
    // tagName, .className, #id, tagName.className#id
    // parent decendent : 자손 요소 찾기.
    ...
    // document.querySelectorAll(selector) : selector로 찾을 수 있는 "모든" 요소들을 collection을 리턴.
