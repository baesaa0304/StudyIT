		...
		<body>
           ...
           System.out.println("intro.jsp - scriptlet");
            ...
            1. Servlet : server + Applet 합성어.
                ...
                - 서블릿 객체ㅢ 생겅과 서블릿 객체의 메서드 호출은 WAS 가 담당.
                 * 최초 요청: 서블릿 객체 생성 -> doGet, doPost 메서드 호출 - > 응답.
                 * 요청 : 생성된 서블릿 객체의 doGet. doPost 메서드 호출 -> 응답.
           ...
           3. JSP 구성 요소(태그)
            ...
            (2) 지시문(directive): <%@....%>
                <%@ page....%>, <%@ include...%>, <%@ taglib...%>,....
            (3) 선언문(declaration): <%! ...%>
                JSP가 Java로 변한될 때, 클래스이 필드와 메서드를 선언하는 부분.    
            (4) 스크립트릿(scriptlet) : <%....%>
                JSP가 자바로 변환될 때, ...JavaService() 메서드 안에 포함되는 자바 코드.
