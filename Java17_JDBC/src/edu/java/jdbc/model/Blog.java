...
public class Blog {
	...
	private LocalDateTime modifiedTime; // 글 최초 수정 시간.
	...
	public String toString() {
		return String.format("Blog(id=%d, title=%s, content=%s, author=%s, createdTime=%s ,modifiedTime=s)",id, title, content, author, createdTime, modifiedTime);
	}	
