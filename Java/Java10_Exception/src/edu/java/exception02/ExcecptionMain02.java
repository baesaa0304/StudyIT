 ...
 * - 발생할 예외를 catch 할 수 없으면 catch 블록이 실행되지 못하고 프로그램은 비정상적으로 종료됨.
 * - catch 블록은 발생하 수 있는 예외 종류에 따라서 여러개르 작성할 수도 있음.
 * - finally 블록은 선택사항 (필수가 아님).
 * 
 * 예외 클래스의 상속 관계 :
 * Object
 * |__ Throwable
 *    |__ Exception
 *      |__ RuntimeExveption
 *       | __ AirhmeticException , NullPointException, ArrayIndexOutOfBoundsException
 *       
 *       
