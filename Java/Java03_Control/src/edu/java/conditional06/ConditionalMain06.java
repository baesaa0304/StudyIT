...
public class ConditionalMain06 {
	...
	public static void main(String[] args) {
		...
		int java = random.nextInt(101); //(0 이상 101미만 (100 이하)의 난수 만듦.
		...
		double avaerage = (java + sql + html) / 3.0;
		System.out.println("평균 :" +avaerage);
		
		if (java >=40 && sql >=40 && html>=40 && avaerage >=60){
		...
		// 삼항 연산자
		String result = (java >=40 && sql >=40 && html>=40 && avaerage >=60) ? "합격" : "불합격";
