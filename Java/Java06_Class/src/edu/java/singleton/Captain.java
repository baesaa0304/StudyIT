...
public class Captain {
	...
	// 생성된 Captain 타입의 객체 주소 값을 저장하기 위한 필드.
	...
	public static Captain getInstance() { // Caption 타입으로 생성된 객체가 없으면,
		if(instance == null) { // Caption 타입 객체를 생성된, 갹체의 주소값을  instance에 저장.
			instance = new Captain();
		}
		
		
		return instance; // Captain 타입 객체 주소값을 리턴.
	}
