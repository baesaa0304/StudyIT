...
public class ClassMain05 {
	...
	public static void main(String[] args) {
		...
		System.out.println(rect1.witdth + " , " + rect1.height);
		rect1.witdth = 1.0; // 생성된 rect1 직사각형 객체의 가로 길이(width)를 변경.
		rect1.height = 2.0; // 생성된 rect1 직사각형 객체의 세로 길이(height)를 변경.
		System.out.println(rect1.perimeter());
		System.out.println(rect1.area());	
		
		// argument를 작는 생성자를 이용한 Rectangle 객체 생성.
		Rectangle rect2 = new Rectangle(4, 3);
		System.out.println(rect2);
		System.out.println(rect2.witdth + " , " + rect2.height);
