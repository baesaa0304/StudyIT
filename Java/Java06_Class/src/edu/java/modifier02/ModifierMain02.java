...
// 패키지 이름을 회사 도메인(naver.com , kakako.com, google.com)을 이용하는 이유는
// 클래스 이름이 같더라도 다른 패키지 이름으로 구별할 수 있도록 하기 위해서.

public class ModifierMain02 {

	public static void main(String[] args) {
	//	edu.java.modifier01.AccessTest test = new edu.java.modifier01.AccessTest(1 ,2 ,3, 4); //import가 x
		AccessTest test = new AccessTest(1, 2, 3, 4); //import가 있어야함.
