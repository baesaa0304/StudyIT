...
public class InheritanceMain06 {
	...
	public static void main(String[] args) {
		...
		// 자바의 모든 클래스는 Object의 protected 또는 public 멤버(메서드)를 상속받아서 사용 가능하고
		// 재정의 (override)할 수 있음.
		// Object 클래스의 메서든 재정의 : toString, equals, hashCode, ...
		
		//System.out.println(Object x);
		// argument로 전달된 객체의 to String () 메서드가 리턴하는 문자열을 콘솔창에 출력.
		// 클래스를 정의할 때, toString() 메서드를 override 해서 원하는 문자열이 출력될 수 있도록 할 수 있음.
		T t = new T();
		...
		// Object 클레스에서 상속받은 toString() 메서드가 리턴하는 문자열을 콘솔창에 출력.
		// -> Point 클래스에서 toString() 메서드를 override(재정의)하면, 
		// println은 point 클래스에서 재정의된 toString 메서드가 리턴하는 문자열을 콘솔팡에 출력.
		...
		System.out.println("gt1 hashCode:" + pt1.hashCode());
		System.out.println("gt2 hashCode:" + pt2.hashCode());
