...
public class wraaperMain {

	public static void main(String[] args) {
		int x = 1; // 기본 타입(private type) - 메서드 없음.
		
		//  Integer 타입의 객체 생성. - 생성자는 사용은 권장하지 않고, static 메서드 사용을 권장.
		...
		int num = Integer.parseInt("100"); // 문자열이 int로 변환할수 있는 문자열이어야함.
