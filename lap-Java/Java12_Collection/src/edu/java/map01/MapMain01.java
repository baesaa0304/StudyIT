...
/*
 * Collection<E>
 *  |__ List<E> , SET<E>  E == Element 원소
 *  List , Set의 공통점 : 한가지 타입의 객체들을 여러개 저장할 수 있는 데이터 타입.
 *  List : 인덱스 있음. 저장하는 순서가 중요.(add 호출할때마다 인덱스 자동 증가). 중복된 값을 저장할 수 있음.
 ...
 *  (예). 1.- 강효남  2.- 김다훈   3.- 김도현.., 20.- 김다훈 (번호는 Key, 이름은 Value)
 *  값은 중복 될수 있음 그러나 키는 중복 되지 않음
 *  
 *  (1) Key : 중복된 값을 가질 수 없음. 연속된 값을 가질 필요는 없음.
 *  	리스트에서 인덱스 역활 (데이터저장, 검색, 수정, 삭제 할 때 값을 찾기 위한 용도).
 *  
...
public class MapMain01 {
	...
	public static void main(String[] args) {
		...
		// key 매핑된 value를 리턴. key에 매핑된 value가 없으면 defaultValue을 리턴.
		...
		// Map에서 항상된 for 문장을 사용하는 방법
		Set<Integer>keySet = students.keySet(); //(1) Map의 Key들롼 이루어진 set을 만듦.
