...
public class MethodMain05 {
	...
	public static void main(String[] args) {
		...
		// 가변 길이 아규먼트에는 몇 개의 값을 전달하는 값의 개수는 제한이 없음. 아규먼트를 전달하지 않아도 됨!
		// 가변 길이 아규먼트는 메서드 안에서는 배열처럼 취급함.
		//(주의) 가변길이 아규먼트는 가장 마지막 파라미터로 선언해야함!
		// (주의) 가변길이 아규먼트를 갖는 파라미터는 오직 1개만 선언 할 수 있음!
	 ...
	 *  op가 "*"이면, 아규먼트로 전달된 숫자가 없으면 1을 리턴.	 
