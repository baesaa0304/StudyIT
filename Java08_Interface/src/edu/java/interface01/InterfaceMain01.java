...
// 인터페이스를 작성할 때는 interface 키워드 사용.
// 인터페이스는 객체를 생성 할 수 없음.
...
public class InterfaceMain01 {
	...
	public static void main(String[] args) {
		...
		//import static 문장을 사용하면 DatabaseModule_DB_verion 를 간단히 DB_VERSION으로 사용할 수 있음.

		
		// new DatabaseModule(); -> 인터페이스는 객체를 생성할 수 없다.
		
		// 인터페이스를 구현하고 있는 클래스의 객체를 생성할 수 있음.

//		OracleDatabaseModule db = new OracleDatabaseModule();
		
		// MariaDBModule db = new MariaDBModule();
		
		// 다향성 : Super Type var = new SubType();
