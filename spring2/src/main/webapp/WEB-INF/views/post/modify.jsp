...
<html>
	<head>
		...
		<div class="container-fluid">
            ...
            <main class="my-2">
            <div class="card">
                <form id="postModifyForm" name= "postModifyForm" class="card-body">
                    <div class="my-2">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-center">
                        <button class=" mx-2 btn btn btn-light" id="btnDelete">삭제</button>
                        <button class=" mx-2 btn btn-secondary" id="btnUpdate">업데이트</button>
                    </div>   
                </div>
            </div>
        </main>
        
        <script src="../static/js/post_modify.js"></script>
