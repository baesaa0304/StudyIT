...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const deleteReply = (e) => {       
       //console.log(e);
       console.log(e.target); // e.target : 이벤트가 발생한 티켓, 여기서는 삭제 버튼.
    ...
    const makeReplyElements = (data) => {
        ...
        replies.innerHTML = ''; // <div>의 컨텐츠를 지움.
        ...
        for (let reply of data) {
            ...
            <div class="my-2 card">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button class="btnDelete btn btn-outline-danger me-md-2 btn-sm" data-id="${reply.id}">
                    삭제</button>
                    <button class="btnModify btn btn-outline-primary btn-sm" data-id="${reply.id}">
                    수정</button>
                </div>
            </div>
            `;
